...
stateDiagram-v2
  ...
  聖遺物一覧画面 --> if_オプション : 「オプション」ボタンを押す
  if_オプション --> 聖遺物編集画面 : 「編集」ボタンを押す
  if_オプション --> 聖遺物削除確認ダイアログ : 「削除」ボタンを押す
  聖遺物登録画面 --> if_登録
...
stateDiagram-v2
  ...
  [*] --> キャラクターマイセット一覧画面 : 「キャラクター」ボタンを押す
  キャラクターマイセット一覧画面 --> キャラクターマイセット登録画面 : 「新規登録」ボタンを押す
  キャラクターマイセット一覧画面 --> if_オプション : 「オプション」ボタンを押す
  if_オプション --> キャラクターマイセット編集画面 : 「編集」ボタンを押す
  if_オプション --> キャラクターマイセット削除確認ダイアログ : 「削除」ボタンを押す
  キャラクターマイセット登録画面 --> if_登録
  if_登録 --> キャラクターマイセット登録内容確認ダイアログ : 「登録」ボタンを押す
  if_登録 --> キャラクターマイセット登録画面 : 「キャンセル」ボタンを押す
  キャラクターマイセット登録内容確認ダイアログ --> キャラクターマイセット一覧画面 : 「次へ」ボタンを押す
  キャラクターマイセット編集画面 --> if_編集
  if_編集 --> キャラクターマイセット編集内容確認ダイアログ : 「登録」ボタンを押す
  if_編集 --> キャラクターマイセット編集画面 : 「キャンセル」ボタンを押す
  キャラクターマイセット編集内容確認ダイアログ --> キャラクターマイセット一覧画面 : 「次へ」ボタンを押す
  キャラクターマイセット削除確認ダイアログ --> if_削除
  if_削除 --> 削除実行結果表示ダイアログ : 「はい」ボタンを押す
  if_削除 --> キャラクターマイセット一覧画面 : 「いいえ」ボタンを押す
  削除実行結果表示ダイアログ --> キャラクターマイセット一覧画面 : 「次へ」ボタンを押す
```
...
stateDiagram-v2
  ...
  ローテーション登録画面 --> if_登録
  if_登録 --> ローテーション登録内容確認ダイアログ : 「登録」ボタンを押す
  if_登録 --> ローテーション登録画面 : 「キャンセル」ボタンを押す
  ローテーション登録内容確認ダイアログ --> ローテーション一覧画面 : 「次へ」ボタンを押す
  ローテーション編集画面 --> if_編集
  if_編集 --> ローテーション編集内容確認ダイアログ : 「登録」ボタンを押す
  if_編集 --> ローテーション編集画面 : 「キャンセル」ボタンを押す
  ローテーション編集内容確認ダイアログ --> ローテーション一覧画面 : 「次へ」ボタンを押す
  ローテーション削除確認ダイアログ --> if_削除
  if_削除 --> 削除実行結果表示ダイアログ : 「はい」ボタンを押す
  if_削除 --> ローテーション一覧画面 : 「いいえ」ボタンを押す
  削除実行結果表示ダイアログ --> ローテーション一覧画面 : 「次へ」ボタンを押す
```

...
| -------- | -------------- | ---- | ---- | ----------------------------- | ------------------ |
| id       | `UUID`         | [x]  | []   |                               | 一意な ID          |
| set      | `ArtifactSet`  | [x]  | []   |                               | 聖遺物のセット     |
| type     | `ArtifactType` | [x]  | [x]  |                               | 聖遺物の部位       |
| mainStat | `Stat`         | [x]  | [x]  | type によって選択肢条件あり   | メインオプション   |
| subStats | `List<Stat>`   | [x]  | []   | 4 つかつ重複不可              | サブオプション     |
| rarity   | `Int`          | [x]  | []   |                               | レア度             |
| level    | `Int`          | [x]  | []   | rarity によって選択肢条件あり | 聖遺物のレベル     |
| score    | `Int`          | [x]  | []   |                               | 聖遺物の会心スコア |

- 出力項目

| 項目名   | 型  | 必須 | Enum | 制約                     | 説明                           |
| -------- | --- | ---- | ---- | ------------------------ | ------------------------------ |
| status   |     |      |      | `success` または `error` | 処理結果のステータス           |
| message  |     |      |      |                          | status に応じたメッセージ      |
| set      |     |      |      |                          | 聖遺物登録内容確認ダイアログ用 |
| type     |     |      |      |                          | 聖遺物登録内容確認ダイアログ用 |
| mainStat |     |      |      |                          | 聖遺物登録内容確認ダイアログ用 |
| subStats |     |      |      |                          | 聖遺物登録内容確認ダイアログ用 |
| rarity   |     |      |      |                          | 聖遺物登録内容確認ダイアログ用 |
| level    |     |      |      |                          | 聖遺物登録内容確認ダイアログ用 |
...
| id                 |     | [x]  |      |      | 一意な ID                  |
| character          |     | [x]  |      |      | キャラクター               |
| characterLevel     |     | [x]  |      | 1-90 | キャラクターのレベル       |
| characterAscension |     | [x]  |      | 0-6  | キャラクターの突破段階     |
| talentLevels       |     | [x]  |      | 1-10 | キャラクターの各天賦レベル |
| constellation      |     | [x]  |      | 0-6  | キャラクターの命の星座     |
| weapon             |     | [x]  |      |      | キャラクターの武器         |
| weaponLevel        |     | [x]  |      | 1-90 | 武器のレベル               |
| weaponAscension    |     | [x]  |      | 0-6  | 武器の突破段階             |
| refinement         |     | [x]  |      | 1-5  | 精錬ランク                 |
...
| status             |     |      |      | `success` または `error` | 処理結果のステータス                           |
| message            |     |      |      |                          | status に応じたメッセージ                      |
| character          |     |      |      |                          | キャラクターマイセット登録内容確認ダイアログ用 |
| characterLevel     |     |      |      |                          | キャラクターマイセット登録内容確認ダイアログ用 |
| characterAscension |     |      |      |                          | キャラクターマイセット登録内容確認ダイアログ用 |
| talentLevels       |     |      |      |                          | キャラクターマイセット登録内容確認ダイアログ用 |
| constellation      |     |      |      |                          | キャラクターマイセット登録内容確認ダイアログ用 |
| weapon             |     |      |      |                          | キャラクターマイセット登録内容確認ダイアログ用 |
| weaponLevel        |     |      |      |                          | キャラクターマイセット登録内容確認ダイアログ用 |
| weaponAscension    |     |      |      |                          | キャラクターマイセット登録内容確認ダイアログ用 |
| refinement         |     |      |      |                          | キャラクターマイセット登録内容確認ダイアログ用 |
...
| id         |     | [x]  |      |                    | 一意な ID            |
| name       |     | [x]  |      |                    | パーティ名           |
| characters |     | [x]  |      | 1-4 人かつ重複不可 | 編成するキャラクター |
| roles      |     | [x]  |      | 火力枠またはバフ枠 | パーティでの役割     |
...
| status     |     |      |      | `success` または `error` | 処理結果のステータス                 |
| message    |     |      |      |                          | status に応じたメッセージ            |
| name       |     |      |      |                          | パーティ編成登録内容確認ダイアログ用 |
| characters |     |      |      |                          | パーティ編成登録内容確認ダイアログ用 |
| roles      |     |      |      |                          | パーティ編成登録内容確認ダイアログ用 |
...
| status  |     |      |      | `success` または `error` | 処理結果のステータス                   |
| message |     |      |      |                          | status に応じたメッセージ              |
| party   |     |      |      |                          | ローテーション登録内容確認ダイアログ用 |
| actions |     |      |      |                          | ローテーション登録内容確認ダイアログ用 |
...
| ---------------- | --- | ---- | ---- | ---- | ---------------------- |
| id               |     | [x]  |      |      | 一意な ID              |
| rotation         |     | [x]  |      |      | 選択したローテーション |
| character        |     | [x]  |      |      | 最適化するキャラクター |
| enemyLevel       |     | [x]  |      |      | 敵のレベル             |
| enemyResistances |     | [x]  |      |      | 敵の耐性               |
...
| message          |     |      |      |                          | status に応じたメッセージ |
| rotation         |     |      |      |                          | 最適化内容確認画面用      |
| character        |     |      |      |                          | 最適化内容確認画面用      |
| enemyLevel       |     |      |      |                          | 最適化内容確認画面用      |
| enemyResistances |     |      |      |                          | 最適化内容確認画面用      |
| artifacts        |     |      |      |                          | 最適化内容確認画面用      |
...
| status            |     |      |      | `success` または `error` | 処理結果のステータス           |
| message           |     |      |      |                          | status に応じたメッセージ      |
| enemyLevel        |     |      |      |                          | ダメージ計算結果詳細表示画面用 |
| enemyResistances  |     |      |      |                          | ダメージ計算結果詳細表示画面用 |
| rotation          |     |      |      |                          | ダメージ計算結果詳細表示画面用 |
| totalDamage       |     |      |      |                          | ダメージ計算結果詳細表示画面用 |
| damagePerRotation |     |      |      |                          | ダメージ計算結果詳細表示画面用 |
| timePerRotation   |     |      |      |                          | ダメージ計算結果詳細表示画面用 |

...
stateDiagram-v2
    state 聖遺物管理 {
        ホーム画面 --> 聖遺物一覧画面
        聖遺物一覧画面 --> 聖遺物登録画面 : 新規登録
        聖遺物一覧画面 --> 聖遺物編集画面 : 編集選択
        聖遺物一覧画面 --> 聖遺物削除確認ダイアログ : 削除選択
        聖遺物削除確認ダイアログ --> 聖遺物一覧画面 : 削除 or キャンセル
        聖遺物登録画面 --> 聖遺物一覧画面 : 登録完了 or キャンセル
        聖遺物編集画面 --> 聖遺物一覧画面 : 編集完了 or キャンセル
    }
```

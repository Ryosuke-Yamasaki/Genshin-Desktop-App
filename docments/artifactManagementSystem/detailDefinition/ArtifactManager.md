...
| メソッド名       | 引数                                       | 戻り値         | 説明                   |
| ---------------- | ------------------------------------------ | -------------- | ---------------------- |
| `addArtifact`    | `ArtifactList`</br>`Artifact`              | `ArtifactList` | 新しい聖遺物を追加する |
| `updateArtifact` | `ArtifactList`</br>`String`</br>`Artifact` | `ArtifactList` | 既存の聖遺物を更新する |
| `removeArtifact` | `ArtifactList`</br>`String`                | `ArtifactList` | 指定の聖遺物を削除する |
